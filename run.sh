...
SCRIPTS=(
    ...
    "usefulApps.sh|Install VLC and a few small KDE-completing utilities|Y"
    "desktopEssentials.sh|Set up Flatpak/Discover, printing, Partition Manager, and the firewall panel|Y"
    "fancyPlasma.sh|Darkly theme, KWin Blur + Magic Lamp, centered KRunner, glass Konsole profile, panel cleanup|Y"
